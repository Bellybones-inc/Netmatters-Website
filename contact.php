                    ...
                    <div class="col-lg-8 col-lg-pull-4">
                      ...
                      <form id="contact_form" action="/includes/upload.php" method="POST">
                        ...
                        <div class="marketing_info_container">
                          ...
                          <p class="policy_text">Please tick this box if you wish to receive marketing information from us. Please see our
                            <a href="#" class="privacy">Privacy Policy</a> for more information on how we use your data.
